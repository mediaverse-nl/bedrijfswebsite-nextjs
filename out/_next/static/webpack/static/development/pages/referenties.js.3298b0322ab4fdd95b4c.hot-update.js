...
var fetchRelative = function fetchRelative(path) {
  ...
  return fetch("".concat(origin).concat(path));
};
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(fetchRelative("/api/users"));
...
//# sourceMappingURL=referenties.js.3298b0322ab4fdd95b4c.hot-update.js.map